...
public class Dois extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btprevios=view.findViewById(R.id.bt_next_frag2);
        btprevios.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavHostFragment.findNavController(Dois.this).navigate(R.id.action_dois_to_umm);
